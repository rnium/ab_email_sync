...
class BuilderParsingTests(SimpleTestCase):
    ...
    def test_consolidate_transactions_preserves_transactions_and_order(self):
        transactions = [make_transaction("first"), make_transaction("second")]
